...
const About = () => {
    return(
        ...
        <p>
          We strive to make the process of job searching easier and more effective, while also offering businesses a
          user-friendly portal to list their openings and find top-tier candidates. We now serve users all over the
